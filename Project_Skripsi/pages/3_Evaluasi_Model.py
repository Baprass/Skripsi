...
EXCEL_PATH = data_folder / "Evaluasi_Model_Final_With_Error.xlsx"

# Cek apakah file Excel ada
if not EXCEL_PATH.exists():
    st.error(f"❌ File Excel tidak ditemukan di: {EXCEL_PATH}")
    st.info("Harap masukkan file 'Evaluasi_Model_Final_With_Error.xlsx' (dari Colab) ke folder 'data_model'.")
    st.stop()
